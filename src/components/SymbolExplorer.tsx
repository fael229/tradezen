...
import { Search, TrendingUp, TrendingDown, Star, StarOff, ExternalLink } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
        ...
        {symbolDetails && !loading && (
          <div className="mt-4 p-4 bg-gradient-to-r from-slate-50 to-emerald-50 rounded-lg border border-emerald-100">
